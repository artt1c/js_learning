// // TASK 1
// function area(numSideA, numSideB) {
...
//
// // TASK 3
// function cylinderArea(height, rad) {
...
//
// // TASK 5
// function htmlParagraphWriter(text) {
//   document.write(`
//     <p>${text}</p>
//   `);
// }
...
// //TASK 7
// function htmlListMoreWriter(text, count) {
//   document.write('<ul>');
...
//   document.write('</ul>');
// }
// htmlListMoreWriter('moretext', 2);
//
// // TASK 8
// function htmlListDifferentArgsWriter(...args) {
//   document.write('<ul>');
...
//
// TASK 13
// function exchange(value, arrAvailableCourse, selectCourse) {
//   let course;
...
// ];
//
// console.log(exchange(10000, courses, 'USD'));